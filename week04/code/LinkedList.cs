...
public class LinkedList : IEnumerable<int>
{
    ...
    public void RemoveTail()
    {
        ...
        {
            _tail.Prev!.Next = null; // Disconnect the previous node from the last node
            _tail = _tail.Prev; // Update the head to be the second to last node
        }
    }
    ...
    {
        if (_tail is not null && _head is not null)
        {
            var current = _head;
            while (current != null)
            {
